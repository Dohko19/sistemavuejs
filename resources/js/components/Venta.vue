            ...
            <div class="card">
                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                <select class="form-control col-md-3" v-model="criterio">
                                    ...
                                    <option value="num_comprobante">Numero de Comprobante</option>
                ...
                <template v-else-if="listado == 0">
                    <div class="card-body">
                        ...
                        <div class="form-group row border">
                            <div class="col-md-4">
                                <label>Articulo <span style="color: orangered" v-show="idarticulo === 0">(*Seleccione)</span></label>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label>Precio <span style="color: orangered" v-show="precio === 0">(*Ingrese Precio)</span></label>
                                    <input type="number" step="any" class="form-control" v-model="precio">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label>Cantidad <span style="color: orangered" v-show="cantidad === 0">(*Ingrese)</span></label>
                                    <input type="number" class="form-control" v-model="cantidad">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label>Descuento <span style="color: orangered">(*Ingrese)</span></label>
                                    ...
                                    <table class="table table-bordered table-striped table-sm">
                                        ...
                                        <tr v-for="(detalle, index) in arrayDetalle" :key="detalle.id">
                                            ...
                                            <td>
                                                ...
                                                <input v-model="detalle.descuento" value="0" type="number" class="form-control">
                                            </td>
                                            <td>
    ...
    export default {
        ...
        methods : {
            ...
            agregarDetalle(){
                ...
                {
                    toastr["warning"]("Debes llenar los campos faltantes (*)", "Ocurrio un error");
                    toastr.options = {
                        "closeButton": true,
                        "debug": false,
                        "newestOnTop": false,
                    ...
                    if (me.encuentra(me.idarticulo))
                    {
                        swal.fire({
                            icon: 'error',
                            title: 'Error...',
                            text: 'El articulo "' + me.articulo + '" ya se encuentra agregado',
                        })
                    }
                    else
                    {
                        ...
                        {
                            toastr["error"]("No hay Stock Disponible", "Error");
                            toastr.options = {
                                "closeButton": true,
                                "debug": false,
                                "newestOnTop": false,
            ...
            validarVenta(){
                ...
                if (me.idcliente == 0) me.errorMostrarMsjVenta.push("Selecciona un Cliente");
                if (me.tipo_comprobante == 0) me.errorMostrarMsjVenta.push("Selecciona el comprobante.");
                if (!me.num_comprobante) me.errorMostrarMsjVenta.push("Ingresa el numero de comprobante.");
                if (!me.impuesto) me.errorMostrarMsjVenta.push("Ingrese el impuesto de compra.");
                if (me.arrayDetalle.length <= 0) me.errorMostrarMsjVenta.push("Ingrese Detalle")
            ...
            verVenta(id){
                ...
                var url= '/venta/obtenerCabezera?id='+ id;
                axios.get(url).then(function (response) {
                    var respuesta= response.data;
                ...
                // datos de detalles
                var urlid = '/venta/obtenerDetalles?id='+ id;
                ...
                swalWithBootstrapButtons.fire({
                    ...
                    if (result.value) {
                        ...
                        axios.put('/venta/desactivar',{
                            ...
                            toastr["warning"]("Venta anulado Correctamente", "Anulado")
